...
void ContextWriter::writeDeclaration(QString &header) const
{
    ...
    header.append(QLatin1String("class ")+contextName+QLatin1String(" : public LBDatabase::ContextLocal\n"
                                                                    "{\n"
                                                                    "\tQ_OBJECT\n"
                                                                    "public:\n"
                                                                    "\tQ_INVOKABLE "));

    header.append(contextName + QLatin1String("(::LBDatabase::Row *row, ::LBDatabase::StorageLocal *parent);\n"));
...
void ContextWriter::writeImplementation(QString &source) const
{
    ...
    "(LBDatabase::Row *row, LBDatabase::StorageLocal *parent) :\n"
        "\tContextLocal(row, parent)\n"
    "{\n"));
