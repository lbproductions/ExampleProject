...
#include "../local/attributelocal.h"
#include "../local/entitytypelocal.h"
#include "../local/enumattributelocal.h"
...
void EntityTypeWriter::writeDeclaration(QString &header) const
{
    ...
    QString baseClass = "LBDatabase::EntityLocal";
    ...
    "{\n"
        "\tQ_OBJECT\n"
    "public:\n"
        "\tQ_INVOKABLE ")+m_classname+QLatin1String("(::LBDatabase::Row *row, ::LBDatabase::ContextLocal *context);\n"
    ...
    foreach(Attribute *attribute, m_entityType->nonInhertitedAttributes()) {
        if(attribute->type() == Attribute::Enum) {
            writeEnum(static_cast<EnumAttributeLocal *>(attribute), header);
        }
    }
...
void EntityTypeWriter::writeImplementation(QString &source) const
{
    ...
    "(LBDatabase::Row *row, LBDatabase::ContextLocal *context) :\n"
...
void EntityTypeWriter::writeEnum(EnumAttributeLocal *attribute, QString &header) const
{
